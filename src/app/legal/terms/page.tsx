            ...
            >
                ...
                <Stack spacing={3} sx={{ my: 3, textAlign: "left" }}>
                    ...
                    <Box>
                        ...
                        <p>
                            The Owner shall not be liable for any failure to perform or delay in performance of any obligation under these Terms if such failure or delay is caused by events beyond the Owner’s reasonable control (“Force Majeure Events”). Force Majeure Events include, but are not limited to, natural disasters, war, terrorism, riots, civil commotion, governmental actions, strikes, lockouts, labour disputes, epidemics, pandemics, fire, flood, earthquake, explosion, infrastructure breakdowns, blackouts, or interruptions in telecommunications or internet services. In such cases, the Owner’s obligations will be suspended for the duration of the Force Majeure Event, and the Owner will not be liable for any damages or losses resulting from such events.
                        </p>
